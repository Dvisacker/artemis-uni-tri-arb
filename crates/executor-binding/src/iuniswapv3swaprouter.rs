...
```*/
    ...
    ///Container for all the [`IUniswapV3SwapRouter`](self) function calls.
    pub enum IUniswapV3SwapRouterCalls {
        exactInputSingle(exactInputSingleCall),
        exactOutputSingle(exactOutputSingleCall),
    }
    #[automatically_derived]
    impl IUniswapV3SwapRouterCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IUniswapV3SwapRouterCalls {
        const NAME: &'static str = "IUniswapV3SwapRouterCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IUniswapV3SwapRouterCalls>] = &[
                {
                    fn exactInputSingle(
                        data: &[u8],
                        validate: bool,
                        ...
                        <exactInputSingleCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV3SwapRouterCalls::exactInputSingle)
                    }
                    exactInputSingle
                },
                {
                    fn exactOutputSingle(
                        ...
                        <exactOutputSingleCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV3SwapRouterCalls::exactOutputSingle)
                    }
                    exactOutputSingle
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IUniswapV3SwapRouter`](self) contract instance.

See the [wrapper's documentation](`IUniswapV3SwapRouterInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IUniswapV3SwapRouterInstance<T, P, N> {
        IUniswapV3SwapRouterInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IUniswapV3SwapRouterInstance<T, P, N>>,
    > {
        IUniswapV3SwapRouterInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IUniswapV3SwapRouterInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IUniswapV3SwapRouter`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IUniswapV3SwapRouter`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IUniswapV3SwapRouterInstance<
        T,
        P,
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IUniswapV3SwapRouterInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IUniswapV3SwapRouterInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IUniswapV3SwapRouterInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IUniswapV3SwapRouterInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IUniswapV3SwapRouterInstance<T, P, N> {
            IUniswapV3SwapRouterInstance {
