...
pub mod getters_and_derivers {
    ...
    pub static GETTERSANDDERIVERS_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static GETTERSANDDERIVERS_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static GETTERSANDDERIVERS_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M> ::core::fmt::Debug for GettersAndDerivers<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(GettersAndDerivers))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> GettersAndDerivers<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, GettersAndDeriversEvents>
        {
            self.0
    ...
    impl ::core::convert::From<EtherTransferGenericFailure> for GettersAndDeriversErrors {
    ...
    impl ::core::convert::From<InvalidBasicOrderParameterEncoding> for GettersAndDeriversErrors {
    ...
    impl ::core::convert::From<MissingOriginalConsiderationItems> for GettersAndDeriversErrors {
    ...
    impl ::core::convert::From<PartialFillsNotEnabledForOrder> for GettersAndDeriversErrors {
