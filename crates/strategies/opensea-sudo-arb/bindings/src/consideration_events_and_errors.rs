...
pub mod consideration_events_and_errors {
    ...
    impl ::core::convert::From<::std::string::String> for ConsiderationEventsAndErrorsErrors {
    ...
    impl ::core::convert::From<ConsiderationNotMet> for ConsiderationEventsAndErrorsErrors {
        fn from(value: ConsiderationNotMet) -> Self {
            Self::ConsiderationNotMet(value)
        }
    }
    impl ::core::convert::From<EtherTransferGenericFailure> for ConsiderationEventsAndErrorsErrors {
        fn from(value: EtherTransferGenericFailure) -> Self {
            Self::EtherTransferGenericFailure(value)
        }
    }
    impl ::core::convert::From<InsufficientEtherSupplied> for ConsiderationEventsAndErrorsErrors {
    ...
    impl ::core::convert::From<InvalidCallToConduit> for ConsiderationEventsAndErrorsErrors {
    ...
    impl ::core::convert::From<InvalidNativeOfferItem> for ConsiderationEventsAndErrorsErrors {
    ...
    impl ::core::convert::From<NoSpecifiedOrdersAvailable> for ConsiderationEventsAndErrorsErrors {
        fn from(value: NoSpecifiedOrdersAvailable) -> Self {
            Self::NoSpecifiedOrdersAvailable(value)
        }
    }
    impl ::core::convert::From<OrderAlreadyFilled> for ConsiderationEventsAndErrorsErrors {
    ...
    impl ::core::convert::From<OrderPartiallyFilled> for ConsiderationEventsAndErrorsErrors {
        fn from(value: OrderPartiallyFilled) -> Self {
            Self::OrderPartiallyFilled(value)
        }
    }
    impl ::core::convert::From<PartialFillsNotEnabledForOrder> for ConsiderationEventsAndErrorsErrors {
    ...
    impl ::ethers::contract::EthLogDecode for ConsiderationEventsAndErrorsEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = CounterIncrementedFilter::decode_log(log) {
                return Ok(ConsiderationEventsAndErrorsEvents::CounterIncrementedFilter(decoded));
            }
            if let Ok(decoded) = OrderCancelledFilter::decode_log(log) {
                return Ok(ConsiderationEventsAndErrorsEvents::OrderCancelledFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = OrderFulfilledFilter::decode_log(log) {
                return Ok(ConsiderationEventsAndErrorsEvents::OrderFulfilledFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = OrderValidatedFilter::decode_log(log) {
                return Ok(ConsiderationEventsAndErrorsEvents::OrderValidatedFilter(
                    decoded,
                ));
            }
    ...
    impl ::core::convert::From<CounterIncrementedFilter> for ConsiderationEventsAndErrorsEvents {
        fn from(value: CounterIncrementedFilter) -> Self {
            Self::CounterIncrementedFilter(value)
        }
    }
    impl ::core::convert::From<OrderCancelledFilter> for ConsiderationEventsAndErrorsEvents {
        fn from(value: OrderCancelledFilter) -> Self {
            Self::OrderCancelledFilter(value)
        }
    }
    impl ::core::convert::From<OrderFulfilledFilter> for ConsiderationEventsAndErrorsEvents {
        fn from(value: OrderFulfilledFilter) -> Self {
            Self::OrderFulfilledFilter(value)
        }
    }
    impl ::core::convert::From<OrderValidatedFilter> for ConsiderationEventsAndErrorsEvents {
