...
pub mod consideration_base {
    ...
    pub static CONSIDERATIONBASE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static CONSIDERATIONBASE_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static CONSIDERATIONBASE_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
        ::ethers::core::types::Bytes::from_static(__DEPLOYED_BYTECODE);
    pub struct ConsiderationBase<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for ConsiderationBase<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for ConsiderationBase<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for ConsiderationBase<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for ConsiderationBase<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(ConsiderationBase))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> ConsiderationBase<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                CONSIDERATIONBASE_ABI.clone(),
                CONSIDERATIONBASE_BYTECODE.clone().into(),
                client,
            );
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ConsiderationBaseEvents>
        {
            self.0
    ...
    pub enum ConsiderationBaseErrors {
    ...
    impl ::ethers::core::abi::AbiDecode for ConsiderationBaseErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ConsiderationBaseErrors {
    ...
    impl ::ethers::contract::ContractRevert for ConsiderationBaseErrors {
    ...
    impl ::core::fmt::Display for ConsiderationBaseErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for ConsiderationBaseErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<BadFraction> for ConsiderationBaseErrors {
        fn from(value: BadFraction) -> Self {
            Self::BadFraction(value)
        }
    }
    impl ::core::convert::From<ConsiderationNotMet> for ConsiderationBaseErrors {
        fn from(value: ConsiderationNotMet) -> Self {
            Self::ConsiderationNotMet(value)
        }
    }
    impl ::core::convert::From<EtherTransferGenericFailure> for ConsiderationBaseErrors {
        fn from(value: EtherTransferGenericFailure) -> Self {
            Self::EtherTransferGenericFailure(value)
        }
    }
    impl ::core::convert::From<InsufficientEtherSupplied> for ConsiderationBaseErrors {
        fn from(value: InsufficientEtherSupplied) -> Self {
            Self::InsufficientEtherSupplied(value)
        }
    }
    impl ::core::convert::From<InvalidBasicOrderParameterEncoding> for ConsiderationBaseErrors {
        fn from(value: InvalidBasicOrderParameterEncoding) -> Self {
            Self::InvalidBasicOrderParameterEncoding(value)
        }
    }
    impl ::core::convert::From<InvalidCallToConduit> for ConsiderationBaseErrors {
        fn from(value: InvalidCallToConduit) -> Self {
            Self::InvalidCallToConduit(value)
        }
    }
    impl ::core::convert::From<InvalidCanceller> for ConsiderationBaseErrors {
        fn from(value: InvalidCanceller) -> Self {
            Self::InvalidCanceller(value)
        }
    }
    impl ::core::convert::From<InvalidConduit> for ConsiderationBaseErrors {
        fn from(value: InvalidConduit) -> Self {
            Self::InvalidConduit(value)
        }
    }
    impl ::core::convert::From<InvalidMsgValue> for ConsiderationBaseErrors {
        fn from(value: InvalidMsgValue) -> Self {
            Self::InvalidMsgValue(value)
        }
    }
    impl ::core::convert::From<InvalidNativeOfferItem> for ConsiderationBaseErrors {
        fn from(value: InvalidNativeOfferItem) -> Self {
            Self::InvalidNativeOfferItem(value)
        }
    }
    impl ::core::convert::From<InvalidTime> for ConsiderationBaseErrors {
        fn from(value: InvalidTime) -> Self {
            Self::InvalidTime(value)
        }
    }
    impl ::core::convert::From<MissingOriginalConsiderationItems> for ConsiderationBaseErrors {
        fn from(value: MissingOriginalConsiderationItems) -> Self {
            Self::MissingOriginalConsiderationItems(value)
        }
    }
    impl ::core::convert::From<NoSpecifiedOrdersAvailable> for ConsiderationBaseErrors {
        fn from(value: NoSpecifiedOrdersAvailable) -> Self {
            Self::NoSpecifiedOrdersAvailable(value)
        }
    }
    impl ::core::convert::From<OrderAlreadyFilled> for ConsiderationBaseErrors {
        fn from(value: OrderAlreadyFilled) -> Self {
            Self::OrderAlreadyFilled(value)
        }
    }
    impl ::core::convert::From<OrderIsCancelled> for ConsiderationBaseErrors {
        fn from(value: OrderIsCancelled) -> Self {
            Self::OrderIsCancelled(value)
        }
    }
    impl ::core::convert::From<OrderPartiallyFilled> for ConsiderationBaseErrors {
        fn from(value: OrderPartiallyFilled) -> Self {
            Self::OrderPartiallyFilled(value)
        }
    }
    impl ::core::convert::From<PartialFillsNotEnabledForOrder> for ConsiderationBaseErrors {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum ConsiderationBaseEvents {
    ...
    impl ::ethers::contract::EthLogDecode for ConsiderationBaseEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = CounterIncrementedFilter::decode_log(log) {
                return Ok(ConsiderationBaseEvents::CounterIncrementedFilter(decoded));
            }
            if let Ok(decoded) = OrderCancelledFilter::decode_log(log) {
                return Ok(ConsiderationBaseEvents::OrderCancelledFilter(decoded));
            }
            if let Ok(decoded) = OrderFulfilledFilter::decode_log(log) {
                return Ok(ConsiderationBaseEvents::OrderFulfilledFilter(decoded));
            }
            if let Ok(decoded) = OrderValidatedFilter::decode_log(log) {
                return Ok(ConsiderationBaseEvents::OrderValidatedFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for ConsiderationBaseEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<CounterIncrementedFilter> for ConsiderationBaseEvents {
        fn from(value: CounterIncrementedFilter) -> Self {
            Self::CounterIncrementedFilter(value)
        }
    }
    impl ::core::convert::From<OrderCancelledFilter> for ConsiderationBaseEvents {
        fn from(value: OrderCancelledFilter) -> Self {
            Self::OrderCancelledFilter(value)
        }
    }
    impl ::core::convert::From<OrderFulfilledFilter> for ConsiderationBaseEvents {
        fn from(value: OrderFulfilledFilter) -> Self {
            Self::OrderFulfilledFilter(value)
        }
    }
    impl ::core::convert::From<OrderValidatedFilter> for ConsiderationBaseEvents {
