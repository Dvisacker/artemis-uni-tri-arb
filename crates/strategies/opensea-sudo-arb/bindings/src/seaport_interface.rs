...
pub mod seaport_interface {
    ...
    impl<M> ::core::ops::Deref for SeaportInterface<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for SeaportInterface<M> {
    ...
    pub enum SeaportInterfaceCalls {
        Cancel(CancelCall),
    ...
    impl ::ethers::core::abi::AbiDecode for SeaportInterfaceCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for SeaportInterfaceCalls {
    ...
    impl ::core::fmt::Display for SeaportInterfaceCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<CancelCall> for SeaportInterfaceCalls {
        fn from(value: CancelCall) -> Self {
            Self::Cancel(value)
        }
    }
    impl ::core::convert::From<FulfillAdvancedOrderCall> for SeaportInterfaceCalls {
    ...
    impl ::core::convert::From<FulfillAvailableOrdersCall> for SeaportInterfaceCalls {
        fn from(value: FulfillAvailableOrdersCall) -> Self {
            Self::FulfillAvailableOrders(value)
        }
    }
    impl ::core::convert::From<FulfillBasicOrderCall> for SeaportInterfaceCalls {
        fn from(value: FulfillBasicOrderCall) -> Self {
            Self::FulfillBasicOrder(value)
        }
    }
    impl ::core::convert::From<FulfillOrderCall> for SeaportInterfaceCalls {
        fn from(value: FulfillOrderCall) -> Self {
            Self::FulfillOrder(value)
        }
    }
    impl ::core::convert::From<GetCounterCall> for SeaportInterfaceCalls {
        fn from(value: GetCounterCall) -> Self {
            Self::GetCounter(value)
        }
    }
    impl ::core::convert::From<GetOrderHashCall> for SeaportInterfaceCalls {
        fn from(value: GetOrderHashCall) -> Self {
            Self::GetOrderHash(value)
        }
    }
    impl ::core::convert::From<GetOrderStatusCall> for SeaportInterfaceCalls {
        fn from(value: GetOrderStatusCall) -> Self {
            Self::GetOrderStatus(value)
        }
    }
    impl ::core::convert::From<IncrementCounterCall> for SeaportInterfaceCalls {
        fn from(value: IncrementCounterCall) -> Self {
            Self::IncrementCounter(value)
        }
    }
    impl ::core::convert::From<InformationCall> for SeaportInterfaceCalls {
        fn from(value: InformationCall) -> Self {
            Self::Information(value)
        }
    }
    impl ::core::convert::From<MatchAdvancedOrdersCall> for SeaportInterfaceCalls {
        fn from(value: MatchAdvancedOrdersCall) -> Self {
            Self::MatchAdvancedOrders(value)
        }
    }
    impl ::core::convert::From<MatchOrdersCall> for SeaportInterfaceCalls {
        fn from(value: MatchOrdersCall) -> Self {
            Self::MatchOrders(value)
        }
    }
    impl ::core::convert::From<NameCall> for SeaportInterfaceCalls {
        fn from(value: NameCall) -> Self {
            Self::Name(value)
        }
    }
    impl ::core::convert::From<ValidateCall> for SeaportInterfaceCalls {
