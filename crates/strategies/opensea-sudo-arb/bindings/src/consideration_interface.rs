...
pub mod consideration_interface {
    ...
    pub static CONSIDERATIONINTERFACE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl ::core::convert::From<FulfillAdvancedOrderCall> for ConsiderationInterfaceCalls {
        fn from(value: FulfillAdvancedOrderCall) -> Self {
            Self::FulfillAdvancedOrder(value)
        }
    }
    impl ::core::convert::From<FulfillAvailableAdvancedOrdersCall> for ConsiderationInterfaceCalls {
        fn from(value: FulfillAvailableAdvancedOrdersCall) -> Self {
            Self::FulfillAvailableAdvancedOrders(value)
        }
    }
    impl ::core::convert::From<FulfillAvailableOrdersCall> for ConsiderationInterfaceCalls {
