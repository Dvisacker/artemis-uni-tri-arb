...
pub mod curve_error_codes {
    ...
    pub static CURVEERRORCODES_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static CURVEERRORCODES_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static CURVEERRORCODES_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M> ::core::fmt::Debug for CurveErrorCodes<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(CurveErrorCodes))
                .field(&self.address())
                .finish()
        }
    }
