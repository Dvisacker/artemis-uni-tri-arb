pub use lssvm_pair_missing_enumerable::*;
...
pub mod lssvm_pair_missing_enumerable {
    ...
    pub static LSSVMPAIRMISSINGENUMERABLE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct LSSVMPairMissingEnumerable<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for LSSVMPairMissingEnumerable<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for LSSVMPairMissingEnumerable<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for LSSVMPairMissingEnumerable<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for LSSVMPairMissingEnumerable<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(LSSVMPairMissingEnumerable))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> LSSVMPairMissingEnumerable<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(::ethers::contract::Contract::new(
                address.into(),
                LSSVMPAIRMISSINGENUMERABLE_ABI.clone(),
                client,
            ))
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            LSSVMPairMissingEnumerableEvents,
        > {
            self.0
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
        for LSSVMPairMissingEnumerable<M>
    {
    ...
    pub enum LSSVMPairMissingEnumerableErrors {
    ...
    impl ::ethers::core::abi::AbiDecode for LSSVMPairMissingEnumerableErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for LSSVMPairMissingEnumerableErrors {
    ...
    impl ::ethers::contract::ContractRevert for LSSVMPairMissingEnumerableErrors {
    ...
    impl ::core::fmt::Display for LSSVMPairMissingEnumerableErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for LSSVMPairMissingEnumerableErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<BondingCurveError> for LSSVMPairMissingEnumerableErrors {
        fn from(value: BondingCurveError) -> Self {
            Self::BondingCurveError(value)
        }
    }
    impl ::core::convert::From<Ownable_NewOwnerZeroAddress> for LSSVMPairMissingEnumerableErrors {
        fn from(value: Ownable_NewOwnerZeroAddress) -> Self {
            Self::Ownable_NewOwnerZeroAddress(value)
        }
    }
    impl ::core::convert::From<Ownable_NotOwner> for LSSVMPairMissingEnumerableErrors {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum LSSVMPairMissingEnumerableEvents {
    ...
    impl ::ethers::contract::EthLogDecode for LSSVMPairMissingEnumerableEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = AssetRecipientChangeFilter::decode_log(log) {
                return Ok(LSSVMPairMissingEnumerableEvents::AssetRecipientChangeFilter(decoded));
            }
            if let Ok(decoded) = DeltaUpdateFilter::decode_log(log) {
                return Ok(LSSVMPairMissingEnumerableEvents::DeltaUpdateFilter(decoded));
            }
            if let Ok(decoded) = FeeUpdateFilter::decode_log(log) {
                return Ok(LSSVMPairMissingEnumerableEvents::FeeUpdateFilter(decoded));
            }
            if let Ok(decoded) = NftwithdrawalFilter::decode_log(log) {
                return Ok(LSSVMPairMissingEnumerableEvents::NftwithdrawalFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(LSSVMPairMissingEnumerableEvents::OwnershipTransferredFilter(decoded));
            }
            if let Ok(decoded) = SpotPriceUpdateFilter::decode_log(log) {
                return Ok(LSSVMPairMissingEnumerableEvents::SpotPriceUpdateFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = SwapNFTInPairFilter::decode_log(log) {
                return Ok(LSSVMPairMissingEnumerableEvents::SwapNFTInPairFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = SwapNFTOutPairFilter::decode_log(log) {
                return Ok(LSSVMPairMissingEnumerableEvents::SwapNFTOutPairFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = TokenDepositFilter::decode_log(log) {
                return Ok(LSSVMPairMissingEnumerableEvents::TokenDepositFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = TokenWithdrawalFilter::decode_log(log) {
                return Ok(LSSVMPairMissingEnumerableEvents::TokenWithdrawalFilter(
                    decoded,
                ));
            }
    ...
    impl ::core::fmt::Display for LSSVMPairMissingEnumerableEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AssetRecipientChangeFilter> for LSSVMPairMissingEnumerableEvents {
        fn from(value: AssetRecipientChangeFilter) -> Self {
            Self::AssetRecipientChangeFilter(value)
        }
    }
    impl ::core::convert::From<DeltaUpdateFilter> for LSSVMPairMissingEnumerableEvents {
        fn from(value: DeltaUpdateFilter) -> Self {
            Self::DeltaUpdateFilter(value)
        }
    }
    impl ::core::convert::From<FeeUpdateFilter> for LSSVMPairMissingEnumerableEvents {
        fn from(value: FeeUpdateFilter) -> Self {
            Self::FeeUpdateFilter(value)
        }
    }
    impl ::core::convert::From<NftwithdrawalFilter> for LSSVMPairMissingEnumerableEvents {
        fn from(value: NftwithdrawalFilter) -> Self {
            Self::NftwithdrawalFilter(value)
        }
    }
    impl ::core::convert::From<OwnershipTransferredFilter> for LSSVMPairMissingEnumerableEvents {
        fn from(value: OwnershipTransferredFilter) -> Self {
            Self::OwnershipTransferredFilter(value)
        }
    }
    impl ::core::convert::From<SpotPriceUpdateFilter> for LSSVMPairMissingEnumerableEvents {
        fn from(value: SpotPriceUpdateFilter) -> Self {
            Self::SpotPriceUpdateFilter(value)
        }
    }
    impl ::core::convert::From<SwapNFTInPairFilter> for LSSVMPairMissingEnumerableEvents {
        fn from(value: SwapNFTInPairFilter) -> Self {
            Self::SwapNFTInPairFilter(value)
        }
    }
    impl ::core::convert::From<SwapNFTOutPairFilter> for LSSVMPairMissingEnumerableEvents {
        fn from(value: SwapNFTOutPairFilter) -> Self {
            Self::SwapNFTOutPairFilter(value)
        }
    }
    impl ::core::convert::From<TokenDepositFilter> for LSSVMPairMissingEnumerableEvents {
        fn from(value: TokenDepositFilter) -> Self {
            Self::TokenDepositFilter(value)
        }
    }
    impl ::core::convert::From<TokenWithdrawalFilter> for LSSVMPairMissingEnumerableEvents {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum LSSVMPairMissingEnumerableCalls {
    ...
    impl ::ethers::core::abi::AbiDecode for LSSVMPairMissingEnumerableCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for LSSVMPairMissingEnumerableCalls {
    ...
    impl ::core::fmt::Display for LSSVMPairMissingEnumerableCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AssetRecipientCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: AssetRecipientCall) -> Self {
            Self::AssetRecipient(value)
        }
    }
    impl ::core::convert::From<BondingCurveCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: BondingCurveCall) -> Self {
            Self::BondingCurve(value)
        }
    }
    impl ::core::convert::From<CallCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: CallCall) -> Self {
            Self::Call(value)
        }
    }
    impl ::core::convert::From<ChangeAssetRecipientCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: ChangeAssetRecipientCall) -> Self {
            Self::ChangeAssetRecipient(value)
        }
    }
    impl ::core::convert::From<ChangeDeltaCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: ChangeDeltaCall) -> Self {
            Self::ChangeDelta(value)
        }
    }
    impl ::core::convert::From<ChangeFeeCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: ChangeFeeCall) -> Self {
            Self::ChangeFee(value)
        }
    }
    impl ::core::convert::From<ChangeSpotPriceCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: ChangeSpotPriceCall) -> Self {
            Self::ChangeSpotPrice(value)
        }
    }
    impl ::core::convert::From<DeltaCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: DeltaCall) -> Self {
            Self::Delta(value)
        }
    }
    impl ::core::convert::From<FactoryCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: FactoryCall) -> Self {
            Self::Factory(value)
        }
    }
    impl ::core::convert::From<FeeCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: FeeCall) -> Self {
            Self::Fee(value)
        }
    }
    impl ::core::convert::From<GetAllHeldIdsCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: GetAllHeldIdsCall) -> Self {
            Self::GetAllHeldIds(value)
        }
    }
    impl ::core::convert::From<GetAssetRecipientCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: GetAssetRecipientCall) -> Self {
            Self::GetAssetRecipient(value)
        }
    }
    impl ::core::convert::From<GetBuyNFTQuoteCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: GetBuyNFTQuoteCall) -> Self {
            Self::GetBuyNFTQuote(value)
        }
    }
    impl ::core::convert::From<GetSellNFTQuoteCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: GetSellNFTQuoteCall) -> Self {
            Self::GetSellNFTQuote(value)
        }
    }
    impl ::core::convert::From<InitializeCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: InitializeCall) -> Self {
            Self::Initialize(value)
        }
    }
    impl ::core::convert::From<MulticallCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: MulticallCall) -> Self {
            Self::Multicall(value)
        }
    }
    impl ::core::convert::From<NftCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: NftCall) -> Self {
            Self::Nft(value)
        }
    }
    impl ::core::convert::From<OnERC1155BatchReceivedCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: OnERC1155BatchReceivedCall) -> Self {
            Self::OnERC1155BatchReceived(value)
        }
    }
    impl ::core::convert::From<OnERC1155ReceivedCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: OnERC1155ReceivedCall) -> Self {
            Self::OnERC1155Received(value)
        }
    }
    impl ::core::convert::From<OnERC721ReceivedCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: OnERC721ReceivedCall) -> Self {
            Self::OnERC721Received(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<PairVariantCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: PairVariantCall) -> Self {
            Self::PairVariant(value)
        }
    }
    impl ::core::convert::From<PoolTypeCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: PoolTypeCall) -> Self {
            Self::PoolType(value)
        }
    }
    impl ::core::convert::From<SpotPriceCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: SpotPriceCall) -> Self {
            Self::SpotPrice(value)
        }
    }
    impl ::core::convert::From<SupportsInterfaceCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: SupportsInterfaceCall) -> Self {
            Self::SupportsInterface(value)
        }
    }
    impl ::core::convert::From<SwapNFTsForTokenCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: SwapNFTsForTokenCall) -> Self {
            Self::SwapNFTsForToken(value)
        }
    }
    impl ::core::convert::From<SwapTokenForAnyNFTsCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: SwapTokenForAnyNFTsCall) -> Self {
            Self::SwapTokenForAnyNFTs(value)
        }
    }
    impl ::core::convert::From<SwapTokenForSpecificNFTsCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: SwapTokenForSpecificNFTsCall) -> Self {
            Self::SwapTokenForSpecificNFTs(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for LSSVMPairMissingEnumerableCalls {
        fn from(value: TransferOwnershipCall) -> Self {
            Self::TransferOwnership(value)
        }
    }
    impl ::core::convert::From<WithdrawERC1155Call> for LSSVMPairMissingEnumerableCalls {
        fn from(value: WithdrawERC1155Call) -> Self {
            Self::WithdrawERC1155(value)
        }
    }
    impl ::core::convert::From<WithdrawERC20Call> for LSSVMPairMissingEnumerableCalls {
        fn from(value: WithdrawERC20Call) -> Self {
            Self::WithdrawERC20(value)
        }
    }
    impl ::core::convert::From<WithdrawERC721Call> for LSSVMPairMissingEnumerableCalls {
