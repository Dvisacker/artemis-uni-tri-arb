...
pub mod lssvm_pair_enumerable {
    ...
    pub static LSSVMPAIRENUMERABLE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct LSSVMPairEnumerable<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for LSSVMPairEnumerable<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for LSSVMPairEnumerable<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for LSSVMPairEnumerable<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for LSSVMPairEnumerable<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(LSSVMPairEnumerable))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> LSSVMPairEnumerable<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, LSSVMPairEnumerableEvents>
        {
            self.0
    ...
    pub enum LSSVMPairEnumerableErrors {
    ...
    impl ::ethers::core::abi::AbiDecode for LSSVMPairEnumerableErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for LSSVMPairEnumerableErrors {
    ...
    impl ::ethers::contract::ContractRevert for LSSVMPairEnumerableErrors {
    ...
    impl ::core::fmt::Display for LSSVMPairEnumerableErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for LSSVMPairEnumerableErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<BondingCurveError> for LSSVMPairEnumerableErrors {
        fn from(value: BondingCurveError) -> Self {
            Self::BondingCurveError(value)
        }
    }
    impl ::core::convert::From<Ownable_NewOwnerZeroAddress> for LSSVMPairEnumerableErrors {
        fn from(value: Ownable_NewOwnerZeroAddress) -> Self {
            Self::Ownable_NewOwnerZeroAddress(value)
        }
    }
    impl ::core::convert::From<Ownable_NotOwner> for LSSVMPairEnumerableErrors {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum LSSVMPairEnumerableEvents {
    ...
    impl ::ethers::contract::EthLogDecode for LSSVMPairEnumerableEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = AssetRecipientChangeFilter::decode_log(log) {
                return Ok(LSSVMPairEnumerableEvents::AssetRecipientChangeFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = DeltaUpdateFilter::decode_log(log) {
                return Ok(LSSVMPairEnumerableEvents::DeltaUpdateFilter(decoded));
            }
            if let Ok(decoded) = FeeUpdateFilter::decode_log(log) {
                return Ok(LSSVMPairEnumerableEvents::FeeUpdateFilter(decoded));
            }
            if let Ok(decoded) = NftwithdrawalFilter::decode_log(log) {
                return Ok(LSSVMPairEnumerableEvents::NftwithdrawalFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(LSSVMPairEnumerableEvents::OwnershipTransferredFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = SpotPriceUpdateFilter::decode_log(log) {
                return Ok(LSSVMPairEnumerableEvents::SpotPriceUpdateFilter(decoded));
            }
            if let Ok(decoded) = SwapNFTInPairFilter::decode_log(log) {
                return Ok(LSSVMPairEnumerableEvents::SwapNFTInPairFilter(decoded));
            }
            if let Ok(decoded) = SwapNFTOutPairFilter::decode_log(log) {
                return Ok(LSSVMPairEnumerableEvents::SwapNFTOutPairFilter(decoded));
            }
            if let Ok(decoded) = TokenDepositFilter::decode_log(log) {
                return Ok(LSSVMPairEnumerableEvents::TokenDepositFilter(decoded));
            }
            if let Ok(decoded) = TokenWithdrawalFilter::decode_log(log) {
                return Ok(LSSVMPairEnumerableEvents::TokenWithdrawalFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for LSSVMPairEnumerableEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AssetRecipientChangeFilter> for LSSVMPairEnumerableEvents {
        fn from(value: AssetRecipientChangeFilter) -> Self {
            Self::AssetRecipientChangeFilter(value)
        }
    }
    impl ::core::convert::From<DeltaUpdateFilter> for LSSVMPairEnumerableEvents {
        fn from(value: DeltaUpdateFilter) -> Self {
            Self::DeltaUpdateFilter(value)
        }
    }
    impl ::core::convert::From<FeeUpdateFilter> for LSSVMPairEnumerableEvents {
        fn from(value: FeeUpdateFilter) -> Self {
            Self::FeeUpdateFilter(value)
        }
    }
    impl ::core::convert::From<NftwithdrawalFilter> for LSSVMPairEnumerableEvents {
        fn from(value: NftwithdrawalFilter) -> Self {
            Self::NftwithdrawalFilter(value)
        }
    }
    impl ::core::convert::From<OwnershipTransferredFilter> for LSSVMPairEnumerableEvents {
        fn from(value: OwnershipTransferredFilter) -> Self {
            Self::OwnershipTransferredFilter(value)
        }
    }
    impl ::core::convert::From<SpotPriceUpdateFilter> for LSSVMPairEnumerableEvents {
        fn from(value: SpotPriceUpdateFilter) -> Self {
            Self::SpotPriceUpdateFilter(value)
        }
    }
    impl ::core::convert::From<SwapNFTInPairFilter> for LSSVMPairEnumerableEvents {
        fn from(value: SwapNFTInPairFilter) -> Self {
            Self::SwapNFTInPairFilter(value)
        }
    }
    impl ::core::convert::From<SwapNFTOutPairFilter> for LSSVMPairEnumerableEvents {
        fn from(value: SwapNFTOutPairFilter) -> Self {
            Self::SwapNFTOutPairFilter(value)
        }
    }
    impl ::core::convert::From<TokenDepositFilter> for LSSVMPairEnumerableEvents {
        fn from(value: TokenDepositFilter) -> Self {
            Self::TokenDepositFilter(value)
        }
    }
    impl ::core::convert::From<TokenWithdrawalFilter> for LSSVMPairEnumerableEvents {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum LSSVMPairEnumerableCalls {
    ...
    impl ::ethers::core::abi::AbiDecode for LSSVMPairEnumerableCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for LSSVMPairEnumerableCalls {
    ...
    impl ::core::fmt::Display for LSSVMPairEnumerableCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AssetRecipientCall> for LSSVMPairEnumerableCalls {
        fn from(value: AssetRecipientCall) -> Self {
            Self::AssetRecipient(value)
        }
    }
    impl ::core::convert::From<BondingCurveCall> for LSSVMPairEnumerableCalls {
        fn from(value: BondingCurveCall) -> Self {
            Self::BondingCurve(value)
        }
    }
    impl ::core::convert::From<CallCall> for LSSVMPairEnumerableCalls {
        fn from(value: CallCall) -> Self {
            Self::Call(value)
        }
    }
    impl ::core::convert::From<ChangeAssetRecipientCall> for LSSVMPairEnumerableCalls {
        fn from(value: ChangeAssetRecipientCall) -> Self {
            Self::ChangeAssetRecipient(value)
        }
    }
    impl ::core::convert::From<ChangeDeltaCall> for LSSVMPairEnumerableCalls {
        fn from(value: ChangeDeltaCall) -> Self {
            Self::ChangeDelta(value)
        }
    }
    impl ::core::convert::From<ChangeFeeCall> for LSSVMPairEnumerableCalls {
        fn from(value: ChangeFeeCall) -> Self {
            Self::ChangeFee(value)
        }
    }
    impl ::core::convert::From<ChangeSpotPriceCall> for LSSVMPairEnumerableCalls {
        fn from(value: ChangeSpotPriceCall) -> Self {
            Self::ChangeSpotPrice(value)
        }
    }
    impl ::core::convert::From<DeltaCall> for LSSVMPairEnumerableCalls {
        fn from(value: DeltaCall) -> Self {
            Self::Delta(value)
        }
    }
    impl ::core::convert::From<FactoryCall> for LSSVMPairEnumerableCalls {
        fn from(value: FactoryCall) -> Self {
            Self::Factory(value)
        }
    }
    impl ::core::convert::From<FeeCall> for LSSVMPairEnumerableCalls {
        fn from(value: FeeCall) -> Self {
            Self::Fee(value)
        }
    }
    impl ::core::convert::From<GetAllHeldIdsCall> for LSSVMPairEnumerableCalls {
        fn from(value: GetAllHeldIdsCall) -> Self {
            Self::GetAllHeldIds(value)
        }
    }
    impl ::core::convert::From<GetAssetRecipientCall> for LSSVMPairEnumerableCalls {
        fn from(value: GetAssetRecipientCall) -> Self {
            Self::GetAssetRecipient(value)
        }
    }
    impl ::core::convert::From<GetBuyNFTQuoteCall> for LSSVMPairEnumerableCalls {
        fn from(value: GetBuyNFTQuoteCall) -> Self {
            Self::GetBuyNFTQuote(value)
        }
    }
    impl ::core::convert::From<GetSellNFTQuoteCall> for LSSVMPairEnumerableCalls {
        fn from(value: GetSellNFTQuoteCall) -> Self {
            Self::GetSellNFTQuote(value)
        }
    }
    impl ::core::convert::From<InitializeCall> for LSSVMPairEnumerableCalls {
        fn from(value: InitializeCall) -> Self {
            Self::Initialize(value)
        }
    }
    impl ::core::convert::From<MulticallCall> for LSSVMPairEnumerableCalls {
        fn from(value: MulticallCall) -> Self {
            Self::Multicall(value)
        }
    }
    impl ::core::convert::From<NftCall> for LSSVMPairEnumerableCalls {
        fn from(value: NftCall) -> Self {
            Self::Nft(value)
        }
    }
    impl ::core::convert::From<OnERC1155BatchReceivedCall> for LSSVMPairEnumerableCalls {
        fn from(value: OnERC1155BatchReceivedCall) -> Self {
            Self::OnERC1155BatchReceived(value)
        }
    }
    impl ::core::convert::From<OnERC1155ReceivedCall> for LSSVMPairEnumerableCalls {
        fn from(value: OnERC1155ReceivedCall) -> Self {
            Self::OnERC1155Received(value)
        }
    }
    impl ::core::convert::From<OnERC721ReceivedCall> for LSSVMPairEnumerableCalls {
        fn from(value: OnERC721ReceivedCall) -> Self {
            Self::OnERC721Received(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for LSSVMPairEnumerableCalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<PairVariantCall> for LSSVMPairEnumerableCalls {
        fn from(value: PairVariantCall) -> Self {
            Self::PairVariant(value)
        }
    }
    impl ::core::convert::From<PoolTypeCall> for LSSVMPairEnumerableCalls {
        fn from(value: PoolTypeCall) -> Self {
            Self::PoolType(value)
        }
    }
    impl ::core::convert::From<SpotPriceCall> for LSSVMPairEnumerableCalls {
        fn from(value: SpotPriceCall) -> Self {
            Self::SpotPrice(value)
        }
    }
    impl ::core::convert::From<SupportsInterfaceCall> for LSSVMPairEnumerableCalls {
        fn from(value: SupportsInterfaceCall) -> Self {
            Self::SupportsInterface(value)
        }
    }
    impl ::core::convert::From<SwapNFTsForTokenCall> for LSSVMPairEnumerableCalls {
        fn from(value: SwapNFTsForTokenCall) -> Self {
            Self::SwapNFTsForToken(value)
        }
    }
    impl ::core::convert::From<SwapTokenForAnyNFTsCall> for LSSVMPairEnumerableCalls {
        fn from(value: SwapTokenForAnyNFTsCall) -> Self {
            Self::SwapTokenForAnyNFTs(value)
        }
    }
    impl ::core::convert::From<SwapTokenForSpecificNFTsCall> for LSSVMPairEnumerableCalls {
        fn from(value: SwapTokenForSpecificNFTsCall) -> Self {
            Self::SwapTokenForSpecificNFTs(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for LSSVMPairEnumerableCalls {
        fn from(value: TransferOwnershipCall) -> Self {
            Self::TransferOwnership(value)
        }
    }
    impl ::core::convert::From<WithdrawERC1155Call> for LSSVMPairEnumerableCalls {
        fn from(value: WithdrawERC1155Call) -> Self {
            Self::WithdrawERC1155(value)
        }
    }
    impl ::core::convert::From<WithdrawERC20Call> for LSSVMPairEnumerableCalls {
        fn from(value: WithdrawERC20Call) -> Self {
            Self::WithdrawERC20(value)
        }
    }
    impl ::core::convert::From<WithdrawERC721Call> for LSSVMPairEnumerableCalls {
