...
pub mod lssvm_pair_eth {
    ...
    pub static LSSVMPAIRETH_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct LSSVMPairETH<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for LSSVMPairETH<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for LSSVMPairETH<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for LSSVMPairETH<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for LSSVMPairETH<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(LSSVMPairETH))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> LSSVMPairETH<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, LSSVMPairETHEvents>
        {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for LSSVMPairETH<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for LSSVMPairETHErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for LSSVMPairETHErrors {
    ...
    impl ::ethers::contract::ContractRevert for LSSVMPairETHErrors {
    ...
    impl ::core::fmt::Display for LSSVMPairETHErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for LSSVMPairETHErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<BondingCurveError> for LSSVMPairETHErrors {
        fn from(value: BondingCurveError) -> Self {
            Self::BondingCurveError(value)
        }
    }
    impl ::core::convert::From<Ownable_NewOwnerZeroAddress> for LSSVMPairETHErrors {
        fn from(value: Ownable_NewOwnerZeroAddress) -> Self {
            Self::Ownable_NewOwnerZeroAddress(value)
        }
    }
    impl ::core::convert::From<Ownable_NotOwner> for LSSVMPairETHErrors {
    ...
    impl ::ethers::contract::EthLogDecode for LSSVMPairETHEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = AssetRecipientChangeFilter::decode_log(log) {
                return Ok(LSSVMPairETHEvents::AssetRecipientChangeFilter(decoded));
            }
            if let Ok(decoded) = DeltaUpdateFilter::decode_log(log) {
                return Ok(LSSVMPairETHEvents::DeltaUpdateFilter(decoded));
            }
            if let Ok(decoded) = FeeUpdateFilter::decode_log(log) {
                return Ok(LSSVMPairETHEvents::FeeUpdateFilter(decoded));
            }
            if let Ok(decoded) = NftwithdrawalFilter::decode_log(log) {
                return Ok(LSSVMPairETHEvents::NftwithdrawalFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(LSSVMPairETHEvents::OwnershipTransferredFilter(decoded));
            }
            if let Ok(decoded) = SpotPriceUpdateFilter::decode_log(log) {
                return Ok(LSSVMPairETHEvents::SpotPriceUpdateFilter(decoded));
            }
            if let Ok(decoded) = SwapNFTInPairFilter::decode_log(log) {
                return Ok(LSSVMPairETHEvents::SwapNFTInPairFilter(decoded));
            }
            if let Ok(decoded) = SwapNFTOutPairFilter::decode_log(log) {
                return Ok(LSSVMPairETHEvents::SwapNFTOutPairFilter(decoded));
            }
            if let Ok(decoded) = TokenDepositFilter::decode_log(log) {
                return Ok(LSSVMPairETHEvents::TokenDepositFilter(decoded));
            }
            if let Ok(decoded) = TokenWithdrawalFilter::decode_log(log) {
                return Ok(LSSVMPairETHEvents::TokenWithdrawalFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for LSSVMPairETHEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AssetRecipientChangeFilter> for LSSVMPairETHEvents {
        fn from(value: AssetRecipientChangeFilter) -> Self {
            Self::AssetRecipientChangeFilter(value)
        }
    }
    impl ::core::convert::From<DeltaUpdateFilter> for LSSVMPairETHEvents {
        fn from(value: DeltaUpdateFilter) -> Self {
            Self::DeltaUpdateFilter(value)
        }
    }
    impl ::core::convert::From<FeeUpdateFilter> for LSSVMPairETHEvents {
        fn from(value: FeeUpdateFilter) -> Self {
            Self::FeeUpdateFilter(value)
        }
    }
    impl ::core::convert::From<NftwithdrawalFilter> for LSSVMPairETHEvents {
        fn from(value: NftwithdrawalFilter) -> Self {
            Self::NftwithdrawalFilter(value)
        }
    }
    impl ::core::convert::From<OwnershipTransferredFilter> for LSSVMPairETHEvents {
        fn from(value: OwnershipTransferredFilter) -> Self {
            Self::OwnershipTransferredFilter(value)
        }
    }
    impl ::core::convert::From<SpotPriceUpdateFilter> for LSSVMPairETHEvents {
        fn from(value: SpotPriceUpdateFilter) -> Self {
            Self::SpotPriceUpdateFilter(value)
        }
    }
    impl ::core::convert::From<SwapNFTInPairFilter> for LSSVMPairETHEvents {
        fn from(value: SwapNFTInPairFilter) -> Self {
            Self::SwapNFTInPairFilter(value)
        }
    }
    impl ::core::convert::From<SwapNFTOutPairFilter> for LSSVMPairETHEvents {
        fn from(value: SwapNFTOutPairFilter) -> Self {
            Self::SwapNFTOutPairFilter(value)
        }
    }
    impl ::core::convert::From<TokenDepositFilter> for LSSVMPairETHEvents {
        fn from(value: TokenDepositFilter) -> Self {
            Self::TokenDepositFilter(value)
        }
    }
    impl ::core::convert::From<TokenWithdrawalFilter> for LSSVMPairETHEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for LSSVMPairETHCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for LSSVMPairETHCalls {
    ...
    impl ::core::fmt::Display for LSSVMPairETHCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AssetRecipientCall> for LSSVMPairETHCalls {
        fn from(value: AssetRecipientCall) -> Self {
            Self::AssetRecipient(value)
        }
    }
    impl ::core::convert::From<BondingCurveCall> for LSSVMPairETHCalls {
        fn from(value: BondingCurveCall) -> Self {
            Self::BondingCurve(value)
        }
    }
    impl ::core::convert::From<CallCall> for LSSVMPairETHCalls {
        fn from(value: CallCall) -> Self {
            Self::Call(value)
        }
    }
    impl ::core::convert::From<ChangeAssetRecipientCall> for LSSVMPairETHCalls {
        fn from(value: ChangeAssetRecipientCall) -> Self {
            Self::ChangeAssetRecipient(value)
        }
    }
    impl ::core::convert::From<ChangeDeltaCall> for LSSVMPairETHCalls {
        fn from(value: ChangeDeltaCall) -> Self {
            Self::ChangeDelta(value)
        }
    }
    impl ::core::convert::From<ChangeFeeCall> for LSSVMPairETHCalls {
        fn from(value: ChangeFeeCall) -> Self {
            Self::ChangeFee(value)
        }
    }
    impl ::core::convert::From<ChangeSpotPriceCall> for LSSVMPairETHCalls {
        fn from(value: ChangeSpotPriceCall) -> Self {
            Self::ChangeSpotPrice(value)
        }
    }
    impl ::core::convert::From<DeltaCall> for LSSVMPairETHCalls {
        fn from(value: DeltaCall) -> Self {
            Self::Delta(value)
        }
    }
    impl ::core::convert::From<FactoryCall> for LSSVMPairETHCalls {
        fn from(value: FactoryCall) -> Self {
            Self::Factory(value)
        }
    }
    impl ::core::convert::From<FeeCall> for LSSVMPairETHCalls {
        fn from(value: FeeCall) -> Self {
            Self::Fee(value)
        }
    }
    impl ::core::convert::From<GetAllHeldIdsCall> for LSSVMPairETHCalls {
        fn from(value: GetAllHeldIdsCall) -> Self {
            Self::GetAllHeldIds(value)
        }
    }
    impl ::core::convert::From<GetAssetRecipientCall> for LSSVMPairETHCalls {
        fn from(value: GetAssetRecipientCall) -> Self {
            Self::GetAssetRecipient(value)
        }
    }
    impl ::core::convert::From<GetBuyNFTQuoteCall> for LSSVMPairETHCalls {
        fn from(value: GetBuyNFTQuoteCall) -> Self {
            Self::GetBuyNFTQuote(value)
        }
    }
    impl ::core::convert::From<GetSellNFTQuoteCall> for LSSVMPairETHCalls {
        fn from(value: GetSellNFTQuoteCall) -> Self {
            Self::GetSellNFTQuote(value)
        }
    }
    impl ::core::convert::From<InitializeCall> for LSSVMPairETHCalls {
        fn from(value: InitializeCall) -> Self {
            Self::Initialize(value)
        }
    }
    impl ::core::convert::From<MulticallCall> for LSSVMPairETHCalls {
        fn from(value: MulticallCall) -> Self {
            Self::Multicall(value)
        }
    }
    impl ::core::convert::From<NftCall> for LSSVMPairETHCalls {
        fn from(value: NftCall) -> Self {
            Self::Nft(value)
        }
    }
    impl ::core::convert::From<OnERC1155BatchReceivedCall> for LSSVMPairETHCalls {
        fn from(value: OnERC1155BatchReceivedCall) -> Self {
            Self::OnERC1155BatchReceived(value)
        }
    }
    impl ::core::convert::From<OnERC1155ReceivedCall> for LSSVMPairETHCalls {
        fn from(value: OnERC1155ReceivedCall) -> Self {
            Self::OnERC1155Received(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for LSSVMPairETHCalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<PairVariantCall> for LSSVMPairETHCalls {
        fn from(value: PairVariantCall) -> Self {
            Self::PairVariant(value)
        }
    }
    impl ::core::convert::From<PoolTypeCall> for LSSVMPairETHCalls {
        fn from(value: PoolTypeCall) -> Self {
            Self::PoolType(value)
        }
    }
    impl ::core::convert::From<SpotPriceCall> for LSSVMPairETHCalls {
        fn from(value: SpotPriceCall) -> Self {
            Self::SpotPrice(value)
        }
    }
    impl ::core::convert::From<SupportsInterfaceCall> for LSSVMPairETHCalls {
        fn from(value: SupportsInterfaceCall) -> Self {
            Self::SupportsInterface(value)
        }
    }
    impl ::core::convert::From<SwapNFTsForTokenCall> for LSSVMPairETHCalls {
        fn from(value: SwapNFTsForTokenCall) -> Self {
            Self::SwapNFTsForToken(value)
        }
    }
    impl ::core::convert::From<SwapTokenForAnyNFTsCall> for LSSVMPairETHCalls {
        fn from(value: SwapTokenForAnyNFTsCall) -> Self {
            Self::SwapTokenForAnyNFTs(value)
        }
    }
    impl ::core::convert::From<SwapTokenForSpecificNFTsCall> for LSSVMPairETHCalls {
        fn from(value: SwapTokenForSpecificNFTsCall) -> Self {
            Self::SwapTokenForSpecificNFTs(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for LSSVMPairETHCalls {
        fn from(value: TransferOwnershipCall) -> Self {
            Self::TransferOwnership(value)
        }
    }
    impl ::core::convert::From<WithdrawAllETHCall> for LSSVMPairETHCalls {
        fn from(value: WithdrawAllETHCall) -> Self {
            Self::WithdrawAllETH(value)
        }
    }
    impl ::core::convert::From<WithdrawERC1155Call> for LSSVMPairETHCalls {
        fn from(value: WithdrawERC1155Call) -> Self {
            Self::WithdrawERC1155(value)
        }
    }
    impl ::core::convert::From<WithdrawERC20Call> for LSSVMPairETHCalls {
        fn from(value: WithdrawERC20Call) -> Self {
            Self::WithdrawERC20(value)
        }
    }
    impl ::core::convert::From<WithdrawERC721Call> for LSSVMPairETHCalls {
        fn from(value: WithdrawERC721Call) -> Self {
            Self::WithdrawERC721(value)
        }
    }
    impl ::core::convert::From<WithdrawETHCall> for LSSVMPairETHCalls {
