...
```*/
    ...
    ///Container for all the [`IUniswapV2ERC20`](self) function calls.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IUniswapV2ERC20Calls {
        const NAME: &'static str = "IUniswapV2ERC20Calls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IUniswapV2ERC20Calls>] = &[
                {
                    fn name(
                        data: &[u8],
                        validate: bool,
                ...
                },
                {
                    fn approve(
                        ...
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2ERC20Calls::approve)
                    }
                    approve
                },
                {
                    fn totalSupply(
                        ...
                        <totalSupplyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2ERC20Calls::totalSupply)
                    }
                    totalSupply
                },
                {
                    fn transferFrom(
                        ...
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2ERC20Calls::transferFrom)
                    }
                    transferFrom
                },
                {
                    fn PERMIT_TYPEHASH(
                        ...
                        <PERMIT_TYPEHASHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2ERC20Calls::PERMIT_TYPEHASH)
                    }
                    PERMIT_TYPEHASH
                },
                {
                    fn decimals(
                        ...
                        <decimalsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2ERC20Calls::decimals)
                    }
                    decimals
                },
                {
                    fn DOMAIN_SEPARATOR(
                        ...
                        <DOMAIN_SEPARATORCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2ERC20Calls::DOMAIN_SEPARATOR)
                    }
                    DOMAIN_SEPARATOR
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2ERC20Calls::balanceOf)
                    }
                    balanceOf
                },
                {
                    fn nonces(
                        ...
                        <noncesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2ERC20Calls::nonces)
                    }
                    nonces
                },
                {
                    fn symbol(
                        ...
                        <symbolCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2ERC20Calls::symbol)
                    }
                    symbol
                },
                {
                    fn transfer(
                        ...
                        <transferCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2ERC20Calls::transfer)
                    }
                    transfer
                },
                {
                    fn permit(
                        ...
                        <permitCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2ERC20Calls::permit)
                    }
                    permit
                },
                {
                    fn allowance(
                        ...
                        <allowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2ERC20Calls::allowance)
                    }
                    allowance
                },
            ];
    ...
    ///Container for all the [`IUniswapV2ERC20`](self) events.
    pub enum IUniswapV2ERC20Events {
        Approval(Approval),
        Transfer(Transfer),
    }
    #[automatically_derived]
    impl IUniswapV2ERC20Events {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IUniswapV2ERC20Events {
        const NAME: &'static str = "IUniswapV2ERC20Events";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IUniswapV2ERC20Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
    ...
    /**Creates a new wrapper around an on-chain [`IUniswapV2ERC20`](self) contract instance.

See the [wrapper's documentation](`IUniswapV2ERC20Instance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IUniswapV2ERC20Instance<T, P, N> {
        IUniswapV2ERC20Instance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IUniswapV2ERC20Instance<T, P, N>>,
    > {
        IUniswapV2ERC20Instance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IUniswapV2ERC20Instance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IUniswapV2ERC20`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IUniswapV2ERC20`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IUniswapV2ERC20Instance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IUniswapV2ERC20Instance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IUniswapV2ERC20Instance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IUniswapV2ERC20Instance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IUniswapV2ERC20Instance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IUniswapV2ERC20Instance<T, P, N> {
