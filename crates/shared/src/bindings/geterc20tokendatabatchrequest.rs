...
pub mod GetERC20TokenDataBatchRequest {
    ...
    ///
    /// ```text
    ///0x6080604052600080fdfea26469706673582212208da402d2d5a6d052343074f76b2820c92f5cb55487908f8bad974f6d012dc79b64736f6c634300081a0033
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static DEPLOYED_BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\x80`@R`\0\x80\xFD\xFE\xA2dipfsX\"\x12 \x8D\xA4\x02\xD2\xD5\xA6\xD0R40t\xF7k( \xC9/\\\xB5T\x87\x90\x8F\x8B\xAD\x97Om\x01-\xC7\x9BdsolcC\0\x08\x1A\x003",
    );
    /**Constructor`.
```solidity
constructor(address[] tokens);
