...
```*/
    ...
    pub struct allPairsCall {
        pub idx: alloy::sol_types::private::U256,
    }
    ...
    impl IFactoryCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[30u8, 61u8, 209u8, 139u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IFactoryCalls {
        const NAME: &'static str = "IFactoryCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IFactoryCalls>] = &[
                {
                    fn allPairs(
                        data: &[u8],
                        validate: bool,
    ...
    /**Creates a new wrapper around an on-chain [`IFactory`](self) contract instance.

See the [wrapper's documentation](`IFactoryInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IFactoryInstance<T, P, N> {
        IFactoryInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IFactoryInstance<T, P, N>>,
    > {
        IFactoryInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IFactoryInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IFactory`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IFactory`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IFactoryInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IFactoryInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IFactoryInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IFactoryInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IFactoryInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IFactoryInstance<T, P, N> {
            IFactoryInstance {
    ...
    > IFactoryInstance<T, P, N> {
        ...
        pub fn allPairs(
            &self,
            idx: alloy::sol_types::private::U256,
        ) -> alloy_contract::SolCallBuilder<T, &P, allPairsCall, N> {
            self.call_builder(&allPairsCall { idx })
        }
    }
    /// Event filters.
    #[automatically_derived]
