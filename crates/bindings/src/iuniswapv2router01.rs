...
```*/
    ...
    ///Container for all the [`IUniswapV2Router01`](self) function calls.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IUniswapV2Router01Calls {
        const NAME: &'static str = "IUniswapV2Router01Calls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IUniswapV2Router01Calls>] = &[
                {
                    fn removeLiquidityETH(
                        ...
                        <removeLiquidityETHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::removeLiquidityETH)
                    }
                    removeLiquidityETH
                },
                {
                    fn getAmountOut(
                        ...
                        <getAmountOutCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::getAmountOut)
                    }
                    getAmountOut
                },
                {
                    fn swapExactTokensForETH(
                        ...
                        <swapExactTokensForETHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::swapExactTokensForETH)
                    }
                ...
                },
                {
                    fn getAmountsIn(
                        ...
                        <getAmountsInCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::getAmountsIn)
                    }
                    getAmountsIn
                },
                {
                    fn removeLiquidityWithPermit(
                        ...
                        <removeLiquidityWithPermitCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::removeLiquidityWithPermit)
                    }
                ...
                },
                {
                    fn swapExactTokensForTokens(
                        ...
                        <swapExactTokensForTokensCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::swapExactTokensForTokens)
                    }
                ...
                },
                {
                    fn swapTokensForExactETH(
                        ...
                        <swapTokensForExactETHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::swapTokensForExactETH)
                    }
                ...
                },
                {
                    fn swapExactETHForTokens(
                        ...
                        <swapExactETHForTokensCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::swapExactETHForTokens)
                    }
                ...
                },
                {
                    fn getAmountIn(
                        ...
                        <getAmountInCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::getAmountIn)
                    }
                    getAmountIn
                },
                {
                    fn swapTokensForExactTokens(
                        ...
                        <swapTokensForExactTokensCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::swapTokensForExactTokens)
                    }
                ...
                },
                {
                    fn WETH(
                        ...
                        <WETHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::WETH)
                    }
                    WETH
                },
                {
                    fn quote(
                        ...
                        <quoteCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::quote)
                    }
                    quote
                },
                {
                    fn removeLiquidity(
                        ...
                        <removeLiquidityCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::removeLiquidity)
                    }
                    removeLiquidity
                },
                {
                    fn factory(
                        ...
                        <factoryCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::factory)
                    }
                    factory
                },
                {
                    fn getAmountsOut(
                        ...
                        <getAmountsOutCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::getAmountsOut)
                    }
                    getAmountsOut
                },
                {
                    fn removeLiquidityETHWithPermit(
                        ...
                        <removeLiquidityETHWithPermitCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::removeLiquidityETHWithPermit)
                    }
                ...
                },
                {
                    fn addLiquidity(
                        ...
                        <addLiquidityCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::addLiquidity)
                    }
                    addLiquidity
                },
                {
                    fn addLiquidityETH(
                        ...
                        <addLiquidityETHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::addLiquidityETH)
                    }
                    addLiquidityETH
                },
                {
                    fn swapETHForExactTokens(
                        ...
                        <swapETHForExactTokensCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2Router01Calls::swapETHForExactTokens)
                    }
    ...
    /**Creates a new wrapper around an on-chain [`IUniswapV2Router01`](self) contract instance.

See the [wrapper's documentation](`IUniswapV2Router01Instance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IUniswapV2Router01Instance<T, P, N> {
        IUniswapV2Router01Instance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IUniswapV2Router01Instance<T, P, N>>,
    > {
        IUniswapV2Router01Instance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IUniswapV2Router01Instance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IUniswapV2Router01`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IUniswapV2Router01`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IUniswapV2Router01Instance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IUniswapV2Router01Instance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IUniswapV2Router01Instance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IUniswapV2Router01Instance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IUniswapV2Router01Instance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IUniswapV2Router01Instance<T, P, N> {
