...
```*/
    ...
    pub struct uniswapV3SwapCallbackCall {
        pub amount0Delta: alloy::sol_types::private::I256,
        pub amount1Delta: alloy::sol_types::private::I256,
...
See the [wrapper's documentation](`IUniswapV3SwapCallbackInstance`) for more details.*/
    ...
    >(
        ...
        provider: P,
    ) -> IUniswapV3SwapCallbackInstance<T, P, N> {
        IUniswapV3SwapCallbackInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IUniswapV3SwapCallbackInstance<T, P, N>>,
    > {
        IUniswapV3SwapCallbackInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IUniswapV3SwapCallbackInstance::<T, P, N>::deploy_builder(provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IUniswapV3SwapCallbackInstance<T, P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IUniswapV3SwapCallbackInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IUniswapV3SwapCallbackInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IUniswapV3SwapCallbackInstance<T, P, N> {
    ...
    > IUniswapV3SwapCallbackInstance<T, P, N> {
        ...
        pub fn uniswapV3SwapCallback(
            &self,
            amount0Delta: alloy::sol_types::private::I256,
            amount1Delta: alloy::sol_types::private::I256,
