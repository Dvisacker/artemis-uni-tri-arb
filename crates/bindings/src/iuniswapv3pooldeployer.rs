...
```*/
    ...
    ///Container for all the [`IUniswapV3PoolDeployer`](self) function calls.
    pub enum IUniswapV3PoolDeployerCalls {
        parameters(parametersCall),
    }
    #[automatically_derived]
    impl IUniswapV3PoolDeployerCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IUniswapV3PoolDeployerCalls {
        const NAME: &'static str = "IUniswapV3PoolDeployerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IUniswapV3PoolDeployerCalls>] = &[
                {
                    fn parameters(
                        data: &[u8],
                        validate: bool,
                        ...
                        <parametersCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV3PoolDeployerCalls::parameters)
                    }
                    parameters
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IUniswapV3PoolDeployer`](self) contract instance.

See the [wrapper's documentation](`IUniswapV3PoolDeployerInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IUniswapV3PoolDeployerInstance<T, P, N> {
        IUniswapV3PoolDeployerInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IUniswapV3PoolDeployerInstance<T, P, N>>,
    > {
        IUniswapV3PoolDeployerInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IUniswapV3PoolDeployerInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IUniswapV3PoolDeployer`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IUniswapV3PoolDeployer`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IUniswapV3PoolDeployerInstance<
        T,
        P,
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IUniswapV3PoolDeployerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IUniswapV3PoolDeployerInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IUniswapV3PoolDeployerInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IUniswapV3PoolDeployerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IUniswapV3PoolDeployerInstance<T, P, N> {
            IUniswapV3PoolDeployerInstance {
